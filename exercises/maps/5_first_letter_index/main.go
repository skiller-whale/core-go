...
func main() {
	...
	// Now declare a map called `directory` and populate it
	// using a loop over `codeToName` and the `getFirstLetter` function.
	fmt.Println("First letter of Fish is", getFirstLetter("Fish")) // example

	// Now print the number of countries beginning with M and Z.
